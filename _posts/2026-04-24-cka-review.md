...
약 일주일 후 LF 측에서 응답이 왔다. 내용은 요약하면:
...
2. **Killercoda 트러블슈팅 반복** — 손 근육에 박힐 때까지
...
그래도 CKA 자체는 의미 있는 자격증이다. Kubernetes를 진짜 이해하고 있는지 손으로 증명하는 시험이라는 점에서. 그 과정이 유독 험했기에 더 값지기도 하다.